...
from .views import (
    ...
    UserProfileView, UserPasswordChangeView,
    get_critere_type_audits
)
...
urlpatterns = [
    ...
    path("formulaire/<int:pk>/copy/", copy_formulaire, name="formulaire_copy"),
    ...
    path("liste-audit/<int:pk>/finish/", FinishAuditView.as_view(), name="finish_audit"),
    ...
    path("get-formulaire-structure/", get_formulaire_structure, name="get_formulaire_structure"),
    path("formulaire/quick-create/", quick_create_formulaire, name="formulaire_quick_create"),
    path("critere/save-inline/", save_critere_inline, name="save_critere_inline"),
    path("sous-critere/save-inline/", save_sous_critere_inline, name="save_sous_critere_inline"),
    path("critere/<int:pk>/update-inline/", update_critere_inline, name="update_critere_inline"),
    path("sous-critere/<int:pk>/update-inline/", update_sous_critere_inline, name="update_sous_critere_inline"),
