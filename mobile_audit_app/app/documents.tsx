...
const DocumentsManagementScreen = () => {
  ...
  const renderHeader = () => (
    <View style={styles.tableHeader}>
      ...
      <View style={[styles.headerCell, { width: 45 }]}><Text style={[styles.headerText, { textAlign: 'center' }]}>Type</Text></View>
      <View style={[styles.headerCell, { flex: 1 }]}><Text style={styles.headerText}>Document</Text></View>
      <View style={[styles.headerCell, { width: 120 }]}><Text style={[styles.headerText, { textAlign: 'center' }]}>Processus</Text></View>
      <View style={[styles.headerCell, { width: 90 }]}><Text style={[styles.headerText, { textAlign: 'center' }]}>Vue</Text></View>
  ...
  const renderItem = ({ item, index }) => (
    <View style={styles.tableRow}>
      ...
      <View style={[styles.cell, { flex: 1 }]}><Text style={[styles.cellText, { fontWeight: '700' }]} numberOfLines={1}>{item.name}</Text></View>
...
const styles = StyleSheet.create({
  ...
  addBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#22c55e', paddingHorizontal: 15, paddingVertical: 8, borderRadius: 25 },
  ...
  processBadge: { backgroundColor: '#64748b', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
  processText: { color: '#fff', fontSize: 9, fontWeight: '800' },
  
  ouvrirBtn: { flexDirection: 'row', alignItems: 'center', borderWeight: 1.5, borderColor: '#3b82f6', borderWidth: 1, borderRadius: 15, paddingHorizontal: 10, paddingVertical: 5 },
  ouvrirBtnText: { color: '#3b82f6', fontSize: 10, fontWeight: '700', marginLeft: 4 },
